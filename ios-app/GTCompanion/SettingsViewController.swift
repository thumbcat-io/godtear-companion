    ...
    override func viewDidLoad() {
        ...
        sections = [
            ...
            1: SettingsViewSection(text: "SUPPORT", rows: [
                ...
                3: SettingsViewRow(
                    text: "GTCompanion is an open source project licensed under the Apache License, Version 2.0.",
                    textColor: nil,
                    textAlignment: nil,
                    font: nil,
                    isUserInteractionEnabled: nil,
            ...
            2: SettingsViewSection(text: "GODTEAR", rows: [
                ...
                2: SettingsViewRow(
                    text: "GTCompanion © Copyright 2020 Thumbcat Software Solutions, LLC.",
                    textColor: nil,
                    textAlignment: nil,
                    font: nil,
                    isUserInteractionEnabled: nil,
